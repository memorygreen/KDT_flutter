...
class ExMultiSend extends StatefulWidget {
  ...
  @override
  State<ExMultiSend> createState() => _ExMultiSendState();
}
...
class _ExMultiSendState extends State<ExMultiSend> {
  @override
  ...
  void multiImgSend() async{
    String url = "http://211.48.213.193:8091/img/multiUpload";

    FormData data = FormData.fromMap({});
    // 이미지 여러장 --> 하나씩 data에 집어 넣기

    for(var item in img_list){
      // FormData에 데이터 집어 넣는 법
      data.files.addAll([
